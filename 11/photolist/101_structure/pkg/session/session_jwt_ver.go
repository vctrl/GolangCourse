...
import (
	...
	"coursera/3p/photolist/101_structure/pkg/utils/randutils"
...
func (sm *SessionsJWTVer) Create(w http.ResponseWriter, user UserInterface) error {
...
func (sm *SessionsJWTVer) DestroyAll(w http.ResponseWriter, user UserInterface) error {
	// но!
